...
function activateButton(){
    ...
    let cep = document.getElementById("error-cep").hidden;
    ...
    if(cpf && cep && senha && confirm && email){
...
function formatarCEP(cep) {
    ...
    cep = cep.replace(/(\d{5})(\d)/, '$1-$2'); // Adiciona o traço
    return cep;
}

// Função para tratar o evento de entrada no campo de CEP
function mascaraCEP(input) {
    ...
    if(cep.length!=8){
        ...
        document.getElementById("error-cep").textContent="Insira um cep válido.";
    }else{
...
// Adicione o evento de entrada ao campo de CEP
